...
(function(/*! Stitch !*/) {
  ...
  var Editing, HomeView, MainRouter, Stats;
  window.app = {};
  app.routers = {};
  app.models = {};
  app.collections = {};
  ...
  window.renderMarkdown = function() {
    $('#markdown').html(window.converter.makeHtml("# " + $('#title').val() + "\n\n" + $('#body').val()));
    app.models.editing.set({
      title: $('#title').val()
    }, {
      silent: true
    });
    return app.models.editing.set({
      body: $('#body').val()
    }, {
      silent: true
    });
...
}, "models/editing": function(exports, require, module) {(function() {
  ...
  exports.Editing = (function() {
    __extends(Editing, Backbone.Model);
    function Editing() {
      Editing.__super__.constructor.apply(this, arguments);
    }
    Editing.prototype.defaults = {
      title: 'title',
      body: 'body',
...
}, "models/stats": function(exports, require, module) {(function() {
  var __hasProp = Object.prototype.hasOwnProperty, __extends = function(child, parent) {
    for (var key in parent) { if (__hasProp.call(parent, key)) child[key] = parent[key]; }
    function ctor() { this.constructor = child; }
    ctor.prototype = parent.prototype;
  ...
  exports.Stats = (function() {
    __extends(Stats, Backbone.Model);
    function Stats() {
      Stats.__super__.constructor.apply(this, arguments);
    }
    Stats.prototype.defaults = {
      remaining: 'n/a',
      completed: []
    };
    return Stats;
  ...
  (function() {
    (function() {
      var id, link, _ref;
      __out.push('<div id=\'stats\'>\n  <strong>Remaining: </strong>');
      __out.push(this.stats.get('remaining'));
      __out.push('<br />\n  <strong>You\'ve completed (');
      __out.push(this.stats.get('completed_count'));
      __out.push(')</strong>\n  <ul>\n    ');
      _ref = this.stats.get('completed');
      for (id in _ref) {
        link = _ref[id];
        __out.push('\n      <li>');
        __out.push(link.link);
        __out.push('</li>\n    ');
      }
      __out.push('\n  </ul>\n</div>\n\n<div id="edit">\n  <div id="tools">\n    <button id="new">Load new</button>\n    <button id="clean">remove line endings</button>\n    <button id="render">Render Markdown</button>\n    <button id="save">save</button>\n  </div>\n  <br />Original link: <span id="original-link">');
      __out.push(this.editing.get('link'));
      __out.push('</span>\n  <input type="text" id="title" value="');
      __out.push(__sanitize(this.editing.get('title')));
      __out.push('" />\n\n<textarea id="body">\n');
      __out.push(this.editing.get('body'));
      __out.push('\n</textarea>\n</div>\n\n<div id="markdown"></div>\n');
    }).call(this);
  ...
  exports.HomeView = (function() {
    ...
    HomeView.prototype.initialize = function() {
      return app.models.editing.bind('change', this.render);
    };
    ...
    HomeView.prototype.loadNew = function() {
      return $.getJSON('http://localhost/family_march5/drupal-edit/next', __bind(function(data, textStatus, jqXHR) {
        var changeh1Toh2;
        changeh1Toh2 = /^#{1}\s/gm;
        data.markdown = data.markdown.replace(changeh1Toh2, '## ');
        app.models.stats.set({
    ...
    HomeView.prototype.removeEndLines = function() {
      var lineEndings, selectedText, text;
      text = $('#body')[0];
      lineEndings = /(\S)\n/gm;
      ...
      $(text).val($(text).val().substring(0, text.selectionStart) + selectedText + $(text).val().substring(text.selectionEnd));
      return renderMarkdown();
    };
    HomeView.prototype.renderText = function() {
      return renderMarkdown();
    };
  ...
  exports.StatsView = (function() {
    ...
    StatsView.prototype.initialize = function() {
      return app.models.stats.bind('change', this.render);
    };
    StatsView.prototype.render = function() {
      $(this.el).html(statsTemplate(app.models.stats));
